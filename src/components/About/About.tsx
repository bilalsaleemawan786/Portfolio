...
import BilalSaleem from "../../assets/BilalSaleem.webp"
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
          Hi there! I'm Bilal, a passionate website developer with expertise in HTML5, CSS3, JavaScript, and ReactJS. I craft responsive, modern, and user-friendly websites tailored to captivate audiences. From sleek landing pages to dynamic web apps, I bring your digital vision to life.
          </p>
        </ScrollAnimation>
        ...
        <div className="hard-skills">
          ...
          <div className="hability">
            <ScrollAnimation animateIn="fadeInUp" delay={0.19 * 1000}>
              <img src={boostrapIcon} alt="bootstrap5" />
            </ScrollAnimation>
          </div>
          <div className="hability">
            <ScrollAnimation animateIn="fadeInUp" delay={0.19 * 1000}>
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.20 * 1000}>
          <img src={BilalSaleem} alt="Bilal Saleem " />
        </ScrollAnimation>
      </div>
    </Container>
  )
